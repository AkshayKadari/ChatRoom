...
public class Chat extends AppCompatActivity implements View.OnClickListener , CityWeatherAdapter.ItemClickCallBack {
    TextView username;
    ImageView logout;
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityWeatherAdapter = new CityWeatherAdapter(allChats,this,R.layout.in_chat_list,user.getUid());
    ...
    public void onClick(View v) {
        ...
        Intent loggOut = new Intent(Chat.this,MainActivity.class);
    ...
    public void OnItemClick(int p) {
        ...
        chatObj toDelete = allChats.get(p);
        mConditionRef = mRoot.child("CompleteChat");
        ...
        if(!toDelete.getImageUrl().toString().equals("NA")) {
            ...
            riversRef.delete().addOnSuccessListener(new OnSuccessListener() {
                ...
                public void onSuccess(Object o) {
                    Toast.makeText(Chat.this, " Deleted",
